...
export class AtMessage {
        ...
        public static isUnso(id: AtId): boolean;
        public static isUnso(x): boolean {

                let token: string;

                if (atIdDict[x]) token = this.idToToken(x);
        ...
        public static isFinal(id: AtId): boolean;
        ...
        private static isError(id: AtId): boolean {
        ...
        private static idToToken(id: AtId): string {
